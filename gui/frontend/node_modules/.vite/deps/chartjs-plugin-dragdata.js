...
// node_modules/chartjs-plugin-dragdata/node_modules/chart.js/dist/chunks/helpers.segment.mjs
function noop() {
}
var uid = function() {
  let id = 0;
...
var elasticIn = (t, s2, p2) => -(Math.pow(2, 10 * (t -= 1)) * Math.sin((t - s2) * TAU / p2));
var elasticOut = (t, s2, p2) => Math.pow(2, -10 * t) * Math.sin((t - s2) * TAU / p2) + 1;
var effects = {
  linear: (t) => t,
  easeInQuad: (t) => t * t,
  easeOutQuad: (t) => -t * (t - 2),
  ...
  easeInOutElastic(t) {
    const s2 = 0.1125;
    const p2 = 0.45;
    return atEdge(t) ? t : t < 0.5 ? 0.5 * elasticIn(t * 2, s2, p2) : 0.5 + 0.5 * elasticOut(t * 2 - 1, s2, p2);
  },
  easeInBack(t) {
    const s2 = 1.70158;
  ...
  easeOutBounce(t) {
    ...
    if (t < 2 / d2) {
      return m2 * (t -= 1.5 / d2) * t + 0.75;
    }
    if (t < 2.5 / d2) {
      return m2 * (t -= 2.25 / d2) * t + 0.9375;
    }
    return m2 * (t -= 2.625 / d2) * t + 0.984375;
  },
...
function _bezierInterpolation(p1, p2, t, mode) {
  ...
  const d2 = _pointInLine(a2, b2, t);
  const e2 = _pointInLine(b2, c2, t);
  return _pointInLine(d2, e2, t);
}
...
function doSplitByStyles(line, segments, points, segmentOptions) {
  ...
  function addStyle(s2, e2, l2, st2) {
    ...
    if (s2 % count !== e2 % count) {
      result.push({ start: s2 % count, end: e2 % count, loop: l2, style: st2 });
      prevStyle = st2;
      start = e2 % count;
    }
  }
...
// node_modules/chartjs-plugin-dragdata/node_modules/chart.js/dist/chart.mjs
var Animator = class {
  constructor() {
    this._request = null;
...
var Chart = class {
  ...
  _getUniformDataChanges() {
    ...
    const makeSet = (idx) => new Set(
      _dataChanges.filter((c2) => c2[0] === idx).map((c2, i2) => i2 + "," + c2.splice(1).join(","))
    );
...
function drawPointLabels(scale, labelCount) {
  ...
  for (let i2 = labelCount - 1; i2 >= 0; i2--) {
    ...
    const { x: x2, y: y2, textAlign, left, top, right, bottom } = scale._pointLabelItems[i2];
...
// node_modules/chartjs-plugin-dragdata/dist/chartjs-plugin-dragdatas.esm.js
var n = { value: () => {
} };
function e() {
...
var s = { svg: "http://www.w3.org/2000/svg", xhtml: u, xlink: "http://www.w3.org/1999/xlink", xml: "http://www.w3.org/XML/1998/namespace", xmlns: "http://www.w3.org/2000/xmlns/" };
function c(t) {
  var n2 = t += "", e2 = n2.indexOf(":");
  return e2 >= 0 && "xmlns" !== (n2 = t.slice(0, e2)) && (t = t.slice(e2 + 1)), s.hasOwnProperty(n2) ? { space: s[n2], local: t } : t;
}
function l(t) {
  return function() {
    var n2 = this.ownerDocument, e2 = this.namespaceURI;
    return e2 === u && n2.documentElement.namespaceURI === u ? n2.createElement(t) : n2.createElementNS(e2, t);
  };
}
function f(t) {
  return function() {
...
function A(t, n2) {
  this.ownerDocument = t.ownerDocument, this.namespaceURI = t.namespaceURI, this._next = null, this._parent = t, this.__data__ = n2;
}
function E(t) {
  return function() {
    return t;
...
function D(t, n2, e2, r2, i2, o2) {
  for (var a2, u2 = 0, s2 = n2.length, c2 = o2.length; u2 < c2; ++u2)
    (a2 = n2[u2]) ? (a2.__data__ = o2[u2], r2[u2] = a2) : e2[u2] = new A(t, o2[u2]);
  for (; u2 < s2; ++u2)
    (a2 = n2[u2]) && (i2[u2] = a2);
}
function S(t, n2, e2, r2, i2, o2, a2) {
  ...
  for (u2 = 0; u2 < f2; ++u2)
    (s2 = n2[u2]) && (p2[u2] = c2 = a2.call(s2, s2.__data__, u2, n2) + "", l2.has(c2) ? i2[u2] = s2 : l2.set(c2, s2));
  for (u2 = 0; u2 < h3; ++u2)
...
function N(t, n2) {
  return t < n2 ? -1 : t > n2 ? 1 : t >= n2 ? 0 : NaN;
}
function P(t) {
  return function() {
...
function T(t, n2) {
  return function() {
    this.setAttribute(t, n2);
  };
}
function k(t, n2) {
  return function() {
    this.setAttributeNS(t.space, t.local, n2);
  };
}
function I(t, n2) {
  return function() {
    var e2 = n2.apply(this, arguments);
    null == e2 ? this.removeAttribute(t) : this.setAttribute(t, e2);
  };
}
function R(t, n2) {
  return function() {
    var e2 = n2.apply(this, arguments);
    null == e2 ? this.removeAttributeNS(t.space, t.local) : this.setAttributeNS(t.space, t.local, e2);
  };
}
function L(t) {
...
function V(t, n2, e2) {
  return function() {
    this.style.setProperty(t, n2, e2);
  };
}
function X(t, n2, e2) {
  return function() {
    var r2 = n2.apply(this, arguments);
    null == r2 ? this.style.removeProperty(t) : this.style.setProperty(t, r2, e2);
  };
}
function j(t, n2) {
  return t.style.getPropertyValue(n2) || L(t).getComputedStyle(t, null).getPropertyValue(n2);
}
function Y(t) {
  return function() {
    delete this[t];
...
function U(t, n2) {
  return function() {
    var e2 = n2.apply(this, arguments);
    null == e2 ? delete this[t] : this[t] = e2;
  };
}
function F(t) {
...
function W(t, n2) {
  return function() {
    (n2.apply(this, arguments) ? G : K)(this, t);
  };
}
function Z() {
  this.textContent = "";
...
function st() {
  var t = this.cloneNode(false), n2 = this.parentNode;
  return n2 ? n2.insertBefore(t, this.nextSibling) : t;
}
function ct() {
  var t = this.cloneNode(true), n2 = this.parentNode;
  return n2 ? n2.insertBefore(t, this.nextSibling) : t;
}
function lt(t) {
  return t.trim().split(/^|\s+/).map(function(t2) {
    var n2 = "", e2 = t2.indexOf(".");
    return e2 >= 0 && (n2 = t2.slice(e2 + 1), t2 = t2.slice(0, e2)), { type: t2, name: n2 };
  });
}
function ft(t) {
  return function() {
...
function pt(t, n2, e2) {
  var r2 = L(t), i2 = r2.CustomEvent;
  "function" == typeof i2 ? i2 = new i2(n2, e2) : (i2 = r2.document.createEvent("Event"), e2 ? (i2.initEvent(n2, e2.bubbles, e2.cancelable), i2.detail = e2.detail) : i2.initEvent(n2, false, false)), t.dispatchEvent(i2);
}
function dt(t, n2) {
  return function() {
    return pt(this, t, n2);
...
function gt(t, n2) {
  return function() {
    return pt(this, t, n2.apply(this, arguments));
  };
}
A.prototype = { constructor: A, appendChild: function(t) {
  return this._parent.insertBefore(t, this._next);
}, insertBefore: function(t, n2) {
  return this._parent.insertBefore(t, n2);
...
var vt = [null];
function yt(t, n2) {
  this._groups = t, this._parents = n2;
}
function mt(t) {
  return "string" == typeof t ? new yt([[document.querySelector(t)]], [document.documentElement]) : new yt([[t]], vt);
}
function _t(t, n2) {
  if (t = function(t2) {
    let n3;
    ...
    if (e2.createSVGPoint) {
      ...
      return r2.x = t.clientX, r2.y = t.clientY, [(r2 = r2.matrixTransform(n2.getScreenCTM().inverse())).x, r2.y];
    }
    if (n2.getBoundingClientRect) {
      var i2 = n2.getBoundingClientRect();
      return [t.clientX - i2.left - n2.clientLeft, t.clientY - i2.top - n2.clientTop];
    }
  }
...
yt.prototype = { constructor: yt, select: function(t) {
  ...
  for (var n2 = t.selection ? t.selection() : t, e2 = this._groups, r2 = n2._groups, i2 = e2.length, o2 = r2.length, a2 = Math.min(i2, o2), u2 = new Array(i2), s2 = 0; s2 < a2; ++s2)
    for (var c2, l2 = e2[s2], f2 = r2[s2], h3 = l2.length, p2 = u2[s2] = new Array(h3), d2 = 0; d2 < h3; ++d2)
  ...
  function n2(n3, e3) {
    return n3 && e3 ? t(n3.__data__, e3.__data__) : !n3 - !e3;
  }
  t || (t = N);
  ...
  for (var t = this._groups, n2 = 0, e2 = t.length; n2 < e2; ++n2)
    for (var r2 = t[n2], i2 = 0, o2 = r2.length; i2 < o2; ++i2) {
      var a2 = r2[i2];
      if (a2)
        return a2;
    }
  ...
  return this.each((null == n2 ? e2.local ? B : P : "function" == typeof n2 ? e2.local ? R : I : e2.local ? k : T)(e2, n2));
}, style: function(t, n2, e2) {
  return arguments.length > 1 ? this.each((null == n2 ? O : "function" == typeof n2 ? X : V)(t, n2, null == e2 ? "" : e2)) : j(this.node(), t);
}, property: function(t, n2) {
  return arguments.length > 1 ? this.each((null == n2 ? Y : "function" == typeof n2 ? U : q)(t, n2)) : this.node()[t];
  ...
  return arguments.length ? this.each(null == t ? Z : ("function" == typeof t ? tt : $)(t)) : this.node().textContent;
}, html: function(t) {
  return arguments.length ? this.each(null == t ? nt : ("function" == typeof t ? rt : et)(t)) : this.node().innerHTML;
}, raise: function() {
  return this.each(it);
}, lower: function() {
  return this.each(ot);
}, append: function(t) {
  var n2 = "function" == typeof t ? t : h(t);
  return this.select(function() {
    return this.appendChild(n2.apply(this, arguments));
  });
}, insert: function(t, n2) {
  var e2 = "function" == typeof t ? t : h(t), r2 = null == n2 ? at : "function" == typeof n2 ? n2 : d(n2);
  return this.select(function() {
...
var wt = { passive: false };
var xt = { capture: true, passive: false };
function bt(t) {
...
var Et = (t) => () => t;
function Dt(t, { sourceEvent: n2, subject: e2, target: r2, identifier: i2, active: o2, x: a2, y: u2, dx: s2, dy: c2, dispatch: l2 }) {
  Object.defineProperties(this, { type: { value: t, enumerable: true, configurable: true }, sourceEvent: { value: n2, enumerable: true, configurable: true }, subject: { value: e2, enumerable: true, configurable: true }, target: { value: r2, enumerable: true, configurable: true }, identifier: { value: i2, enumerable: true, configurable: true }, active: { value: o2, enumerable: true, configurable: true }, x: { value: a2, enumerable: true, configurable: true }, y: { value: u2, enumerable: true, configurable: true }, dx: { value: s2, enumerable: true, configurable: true }, dy: { value: c2, enumerable: true, configurable: true }, _: { value: l2 } });
}
function St(t) {
...
function Mt(t, n2) {
  return null == n2 ? { x: t.x, y: t.y } : n2;
}
function Nt() {
  return navigator.maxTouchPoints || "ontouchstart" in this;
}
function Pt() {
  var t, n2, r2, i2, o2 = St, a2 = Ct, u2 = Mt, s2 = Nt, c2 = {}, l2 = e("start", "drag", "end"), f2 = 0, h3 = 0;
  function p2(t2) {
    t2.on("mousedown.drag", d2).filter(s2).on("touchstart.drag", y2).on("touchmove.drag", m2, wt).on("touchend.drag touchcancel.drag", _2).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function d2(e2, u3) {
    if (!i2 && o2.call(this, e2, u3)) {
      var s3 = w2(this, a2.call(this, e2, u3), e2, u3, "mouse");
      s3 && (mt(e2.view).on("mousemove.drag", g2, xt).on("mouseup.drag", v2, xt), function(t2) {
        var n3 = t2.document.documentElement, e3 = mt(t2).on("dragstart.drag", At, xt);
        "onselectstart" in n3 ? e3.on("selectstart.drag", At, xt) : (n3.__noselect = n3.style.MozUserSelect, n3.style.MozUserSelect = "none");
      }(e2.view), bt(e2), r2 = false, t = e2.clientX, n2 = e2.clientY, s3("start", e2));
    }
  }
  function g2(e2) {
    if (At(e2), !r2) {
      var i3 = e2.clientX - t, o3 = e2.clientY - n2;
      r2 = i3 * i3 + o3 * o3 > h3;
    }
    c2.mouse("drag", e2);
  }
  function v2(t2) {
    mt(t2.view).on("mousemove.drag mouseup.drag", null), function(t3, n3) {
      var e2 = t3.document.documentElement, r3 = mt(t3).on("dragstart.drag", null);
      n3 && (r3.on("click.drag", At, xt), setTimeout(function() {
        r3.on("click.drag", null);
      }, 0)), "onselectstart" in e2 ? r3.on("selectstart.drag", null) : (e2.style.MozUserSelect = e2.__noselect, delete e2.__noselect);
    }(t2.view, r2), At(t2), c2.mouse("end", t2);
  }
  function y2(t2, n3) {
  ...
  function w2(t2, n3, e2, r3, i3, o3) {
    ...
    if (null != (h4 = u2.call(t2, new Dt("beforestart", { sourceEvent: e2, target: p2, identifier: i3, active: f2, x: g3[0], y: g3[1], dx: 0, dy: 0, dispatch: d3 }), r3)))
      return a3 = h4.x - g3[0] || 0, s3 = h4.y - g3[1] || 0, function e3(o4, u3, l3) {
        var v3, y3 = g3;
        switch (o4) {
          case "start":
            c2[i3] = e3, v3 = f2++;
  ...
  }, p2.container = function(t2) {
    return arguments.length ? (a2 = "function" == typeof t2 ? t2 : Et(t2), p2) : a2;
  }, p2.subject = function(t2) {
    return arguments.length ? (u2 = "function" == typeof t2 ? t2 : Et(t2), p2) : u2;
  }, p2.touchable = function(t2) {
    return arguments.length ? (s2 = "function" == typeof t2 ? t2 : Et(!!t2), p2) : s2;
  }, p2.on = function() {
    var t2 = l2.on.apply(l2, arguments);
    return t2 === l2 ? p2 : t2;
  }, p2.clickDistance = function(t2) {
    return arguments.length ? (h3 = (t2 = +t2) * t2, p2) : Math.sqrt(h3);
  }, p2;
}
var Bt;
var Tt;
...
var qt = false;
function Ut(t, n2) {
  return isNaN(n2) ? t : Math.round(t * Math.pow(10, n2)) / Math.pow(10, n2);
}
function Ft(t, n2, e2, r2, i2) {
  let o2, a2;
  const u2 = n2.data.datasets[e2].data[r2];
  if (t.touches ? (o2 = n2.scales[kt].getValueForPixel(t.touches[0].clientX - n2.canvas.getBoundingClientRect().left), a2 = n2.scales[Tt].getValueForPixel(t.touches[0].clientY - n2.canvas.getBoundingClientRect().top)) : (o2 = n2.scales[kt].getValueForPixel(t.clientX - n2.canvas.getBoundingClientRect().left), a2 = n2.scales[Tt].getValueForPixel(t.clientY - n2.canvas.getBoundingClientRect().top)), o2 = Ut(o2, n2.config.options.plugins.dragData.round), a2 = Ut(a2, n2.config.options.plugins.dragData.round), o2 = o2 > n2.scales[kt].max ? n2.scales[kt].max : o2, o2 = o2 < n2.scales[kt].min ? n2.scales[kt].min : o2, a2 = a2 > n2.scales[Tt].max ? n2.scales[Tt].max : a2, a2 = a2 < n2.scales[Tt].min ? n2.scales[Tt].min : a2, Ot) {
    let t2;
    t2 = "y" === n2.config.options.indexAxis ? o2 : a2;
    return Math.abs(t2 - u2[0]) <= Math.abs(t2 - u2[1]) ? [t2, u2[1]] : [u2[0], t2];
  }
  return void 0 !== u2.x && n2.config.options.plugins.dragData.dragX && (u2.x = o2), void 0 !== u2.y ? (false !== n2.config.options.plugins.dragData.dragY && (u2.y = a2), u2) : "y" === n2.config.options.indexAxis ? o2 : a2;
}
var zt = (t, n2, e2, r2) => {
  if (Bt) {
...
var Ht = { id: "dragdata", afterInit: function(t) {
  if (t.config.options.plugins && t.config.options.plugins.dragData) {
    const n2 = t.config.options.plugins.dragData;
    mt(t.canvas).call(Pt().container(t.canvas).on("start", (e2) => ((t2, n3, e3) => {
      if (Bt = n3.getElementsAtEventForMode(t2, "nearest", { intersect: true }, false)[0], Rt = n3.config.type, Bt) {
        let r2 = Bt.datasetIndex, i2 = Bt.index;
        Yt = function(t3) {
          try {
            return t3();
          } catch (t4) {
        ...
        if ("bar" === Rt) {
          ...
          Ot = null !== e4 && Array.isArray(e4) && 2 == e4.length;
          let o3 = Ft(t2, n3, r2, i2);
          Vt = o3 - u2;
        }
        (void 0 === n3.config.options.plugins.dragData.showTooltip || n3.config.options.plugins.dragData.showTooltip) && (n3.config.options.plugins.tooltip || (n3.config.options.plugins.tooltip = {}), n3.config.options.plugins.tooltip.animation = false), "function" == typeof e3 && Bt && false === e3(t2, r2, i2, u2) && (Bt = null);
      }
    })(e2.sourceEvent, t, n2.onDragStart)).on("drag", (e2) => zt(e2.sourceEvent, t, n2, n2.onDrag)).on("end", (e2) => ((t2, n3, e3) => {
      if (jt = void 0, qt = false, n3.config.options.plugins.tooltip && (n3.config.options.plugins.tooltip.animation = Yt, n3.update("none")), "function" == typeof e3 && Bt) {
        ...
        let o2 = function(t3, n4, e4) {
            ...
            return t3.data.datasets[n4].data[e4];
          {
            ...
            if (i3.to && "function" == typeof i3.to) {
              let r4 = t3.data.datasets[n4].data[e4];
              return r4 = i3.to(r4), t3.data.datasets[n4].data[e4] = r4, t3.update("none"), r4;
            }
          }
        }(n3, r2, i2);
        return e3(t2, r2, i2, o2);
      }
...
chart.js/dist/chart.mjs:
   ...
   *)
*/
//# sourceMappingURL=chartjs-plugin-dragdata.js.map
